...
def get_dataloader():
    ...
    dataset = MeterReadingDataset('../prototype/temp_dataset', get_transform(train=True))
    dataset_test = MeterReadingDataset('../prototype/temp_dataset', get_transform(train=False))
