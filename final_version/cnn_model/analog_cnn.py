...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #print(self.image_list[index], label)
        return image, label
...
train_dataset = CustomDataset('../data/meterdigits', transform=train_transforms)
train_loader = DataLoader(train_dataset, batch_size=32, shuffle=True)

# Initialize the model and the optimizer
model = analogReadingModel()
...
def train(num_epochs, cnn, loaders):
    ...
    torch.save(cnn, "analogreadingmodel.pt")
    print("saved")
